...
class _PopularState extends State<Popular>{
 ...
 List<DocumentSnapshot>popularList;
  ...
  Firestore.instance.collection("popular");
    ...
    return Container(
      height: 250,
          ...
          itemBuilder: (context,int i) {
            String imgPath = popularList[i].data['url'];
        ...
        GestureDetector(
              ...
              builder: (BuildContext context) => PopularFull(
                        imgPath2: imgPath,
...
class PopularFull extends StatelessWidget {
  _save() async {
    var response = await Dio().get(imgPath2, options: Options(responseType: ResponseType.bytes));
    final result = await ImageGallerySaver.saveImage(Uint8List.fromList(response.data));
    print(result);
  }
  static const String id = 'PopularFull';
  PopularFull({this.imgPath2});
  String imgPath2;
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
        ...
        width:MediaQuery.of(context).size.height,
          child: Image.network(imgPath2,fit: BoxFit.cover,),
          ),
          GestureDetector(
            onTap: () async{
...
class PopularExtended extends StatefulWidget {
  static const String id = 'PopularExtended';
  @override
  _PopularExtendedState createState() => _PopularExtendedState();
}

class _PopularExtendedState extends State<PopularExtended> {
                ...
                padding: EdgeInsets.only(top:20,bottom:30 ),
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 5, mainAxisSpacing: 10),
                         itemBuilder: (context,i) {
                            String imgPath3 = popularList[i].data['url'];
